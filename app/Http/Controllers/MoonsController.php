...
class MoonsController extends Controller
{
    ...
    public function displayMoons() {
        ...
        foreach($moons as $moon) {
            ...
            $price = $moonCalc->SpatialMoonsOnlyRares($moon->FirstOre, $moon->FirstQuantity, $moon->SecondOre, $moon->SecondQuantity, 
                                             $moon->ThirdOre, $moon->ThirdQuantity, $moon->FourthOre, $moon->FourthQuantity);
            $allyPrice = $moonCalc->SpatialMoonsOutOfAllianceOnlyRares($moon->FirstOre, $moon->FirstQuantity, $moon->SecondOre, $moon->SecondQuantity, 
                                                              $moon->ThirdOre, $moon->ThirdQuantity, $moon->FourthOre, $moon->FourthQuantity);
